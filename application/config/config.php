...
|
*/
$config['base_url'] = 'http://localhost/inannyweb/';
//$config['base_url'] = 'https://inanny.000webhostapp.com/';

/*
|--------------------------------------------------------------------------
| Javascrip file version
|--------------------------------------------------------------------------
|
| Manage javascript file uptodate with client side also.
|
*/
$config['js_version'] = '1';
