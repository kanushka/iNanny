						...
						<div class="row">
							...
							<div class="col s12" style="width: 100%; margin-top:20px;">
								<div class="col s12 m8 l5 signInBtn">
									<a class="waves-effect waves-light btn-large primary-btn-color" id="signInBtn" style="display: flex; align-items: center; justify-content: center; margin: auto;">Sign
										In
