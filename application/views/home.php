...
<nav class="com-nav">
    <div class="nav-wrapper">
        ...
        <ul class="side-nav" id="mobile-demo">
            <li>
                <div class="user-view">
                    <a><img src="<?php echo base_url(); ?>img/logoGreen.png"
                            style="width: 60px; margin-left:10px; margin-top:10px;"></a>
                </div>
            </li>
...
<div id="registerModal" class="modal modal-fixed-footer">
    ...
    <div id="registerModelContent" class="modal-content">
        ...
        <a href="#!" class="brand-logo"
           style="display: flex; justify-content: center; align-items: center; height: 70px;">
