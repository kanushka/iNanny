...
<body>
    <div class="row" style="margin-bottom: 0px;">
        <div class="col s12" style="height: 50vh;  background-image: radial-gradient(50% 100%, #4caf50,50%, #388e3c 69%, #2e7d32 100%); display: flex; align-items: center; justify-content: center; flex-direction: column;">
            ...
            <p style="font-size: 24px; color: #fff; margin-top: 10px; text-align:center;">Sorry, we can't seem to find the page you're looking for</p>
        </div>
    </div>
    <div class="row" style="margin-bottom: 0px;">
        <div class="col s12 m12 l10 offset-l1 xl6 offset-xl3" style="height: 50vh; display: flex; align-items: center;  flex-direction: column;">
            <p style="font-size: 18px; margin-top: 60px; color: #4A4A4A; text-align: center;">You may have typed the address incorrectly or you may have used an outdated link. Not to worry you can go back to our home page by clicking the below button</p>
