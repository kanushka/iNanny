...
<link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>css/user/common-top-nav.css" media="screen,projection" />

<script src="<?php echo base_url(); ?>js/libs/jquery-3.2.1.min.js"></script>

<!-- hidden variables -->
<input type="hidden" id="baseUrl" value="<?php echo base_url(); ?>">
<input type="hidden" id="babyId" value="<?php echo isset($babyId) ? $babyId : null ?>">
